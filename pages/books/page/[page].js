...
import booksPageInitialPathsFee06Resource from '../../../resources/books-page-initial-paths-fee06'
import booksPageInitialPropsB9a47Resource from '../../../resources/books-page-initial-props-b9a47'
...
export async function getStaticPaths() {
  const response = await booksPageInitialPathsFee06Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await booksPageInitialPropsB9a47Resource({
      ...context?.params,
