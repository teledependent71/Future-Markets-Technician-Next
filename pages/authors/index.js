...
import authorsPageInitialProps3d05bResource from '../../resources/authors-page-initial-props-3d05b'
  ...
  return (
    <>
      <div className="authors1-container">
        <Head>
          <title>Authors1 - Future Markets Technician</title>
          <meta
            property="og:title"
            content="Authors1 - Future Markets Technician"
          />
        </Head>
        <DataProvider
...
export async function getStaticProps(context) {
  try {
    const response = await authorsPageInitialProps3d05bResource({
      ...context?.params,
    })
    if (!response) {
      return {
